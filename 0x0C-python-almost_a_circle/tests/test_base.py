...
class TestBase_instantiation(unittest.TestCase):
    """Unitttest for checking instantiation"""
    ...
    def test_dict_id(self):
        self.assertEqual({"name": "John", "age": 30}, Base({"name": "John", "age": 30}).id)
    ...
    def test_bytearray_id(self):
        self.assertEqual(bytearray(b'world'), Base(bytearray(b'world')).id)
